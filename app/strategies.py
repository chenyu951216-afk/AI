...
CLASSES=[SMCLiquidity,OITrendExpansion,FundingSqueeze,VolumeBreakout,FibonacciPullback,VWAPEMAMomentum,MeanReversion,OrderbookImbalance,LiquidationMagnet,LoserReboundCycle,GainerPullbackCycle]
